	...
	NS.validarCriterios = function(){
		...
		if(NS.excel) {
			if(Ext.getCmp(PF+'cmbChequera').getValue() == '')
				...
				var strParams='';
				strParams  = '?nomExcel=ReporteCheques';
				strParams += '&'+'nomParam1=chequera&valParam1='+NS.chequera;
				strParams += '&'+'nomParam2=empresas&valParam2='+NS.empresas;
				strParams += '&'+'nomParam3=divisa&valParam3='+NS.divisa;
				strParams += '&'+'nomParam4=cajas&valParam4='+NS.cajas;
				strParams += '&'+'nomParam5=bancoInf&valParam5='+NS.bancoInf;
				strParams += '&'+'nomParam6=bancoSup&valParam6='+NS.bancoSup;
				strParams += '&'+'nomParam7=fechaIni&valParam7='+NS.fechaIni;
				strParams += '&'+'nomParam8=fechaFin&valParam8='+NS.fechaFin;
				strParams += '&'+'nomParam9=estatusMov&valParam9='+NS.estatusMov;
				strParams += '&'+'nomParam10=estatusEntregado&valParam10='+NS.estatusEntregado;
				strParams += '&'+'nomParam11=origen&valParam11='+NS.origen;
				strParams += '&'+'nomParam12=agrupado&valParam12='+NS.agrupado;
				strParams += '&'+'nomParam13=estatusCb&valParam13='+NS.estatusCb;
				strParams += '&'+'nomParam14=ordenado&valParam14='+NS.ordenado;
				strParams += '&'+'nomParam15=usuario&valParam15='+NS.GI_USUARIO;
				strParams += '&'+'nomParam16=nomEmpresa&valParam16='+NS.nomEmpresa;
				strParams += '&'+'nomParam17=descEstatus&valParam17='+NS.descEstatus;
				strParams += '&'+'nomParam18=subtitulo&valParam18='+NS.subtitulo;
				strParams += '&'+'nomParam19=cheIni&valParam19='+Ext.getCmp(PF + 'txtCheIni').getValue();
				strParams += '&'+'nomParam20=cheFin&valParam20='+Ext.getCmp(PF + 'txtCheFin').getValue();
				
				window.open("/SET/jsp/bfrmwrk/gnrators/genExcel.jsp"+strParams);
