...
public class SOS_PagosServiceLocator extends org.apache.axis.client.Service implements mx.com.gruposalinas.Pagos.SOS_PagosService {

    public SOS_PagosServiceLocator() {
    }


    public SOS_PagosServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public SOS_PagosServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTPS_Port
    private java.lang.String HTTPS_Port_address = "https://10.50.169.21:50001/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_LEGACY_SET_FI&receiverParty=&receiverService=&interface=SOS_Pagos&interfaceNamespace=http%3A%2F%2Fgruposalinas.com.mx%2FPagos";
    ...
    public mx.com.gruposalinas.Pagos.SOS_Pagos getHTTPS_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mx.com.gruposalinas.Pagos.SOS_PagosBindingStub _stub = new mx.com.gruposalinas.Pagos.SOS_PagosBindingStub(portAddress, this);
    ...
    private java.lang.String HTTP_Port_address = "http://10.50.169.21:50000/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_LEGACY_SET_FI&receiverParty=&receiverService=&interface=SOS_Pagos&interfaceNamespace=http%3A%2F%2Fgruposalinas.com.mx%2FPagos";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mx.com.gruposalinas.Pagos.SOS_Pagos.class.isAssignableFrom(serviceEndpointInterface)) {
                mx.com.gruposalinas.Pagos.SOS_PagosBindingStub _stub = new mx.com.gruposalinas.Pagos.SOS_PagosBindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
            if (mx.com.gruposalinas.Pagos.SOS_Pagos.class.isAssignableFrom(serviceEndpointInterface)) {
                mx.com.gruposalinas.Pagos.SOS_PagosBindingStub _stub = new mx.com.gruposalinas.Pagos.SOS_PagosBindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://gruposalinas.com.mx/Pagos", "SOS_PagosService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://gruposalinas.com.mx/Pagos", "HTTPS_Port"));
            ports.add(new javax.xml.namespace.QName("http://gruposalinas.com.mx/Pagos", "HTTP_Port"));
        }
