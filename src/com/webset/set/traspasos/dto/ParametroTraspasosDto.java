...
public class ParametroTraspasosDto {
	...
	private int idArea;
	private int idGrupo;
	private int piFormaPago;
	private int piTipoOperacion;
	...
	private String pvvValor1;
	private String pvvValor2;
	private String identificador;
	private String valores;
	private String psReferencia;
	private int idGrupoFlujoIngreso;
	private int idGrupoFlujoEgreso;
	private int idRubroFlujoIngreso;
	private int idRubroFlujoEgreso;
	
	public int getIdGrupoFlujoIngreso() {
		return idGrupoFlujoIngreso;
	}
	public void setIdGrupoFlujoIngreso(int idGrupoFlujoIngreso) {
		this.idGrupoFlujoIngreso = idGrupoFlujoIngreso;
	}
	public int getIdGrupoFlujoEgreso() {
		return idGrupoFlujoEgreso;
	}
	public void setIdGrupoFlujoEgreso(int idGrupoFlujoEgreso) {
		this.idGrupoFlujoEgreso = idGrupoFlujoEgreso;
	}
	public int getIdRubroFlujoIngreso() {
		return idRubroFlujoIngreso;
	}
	public void setIdRubroFlujoIngreso(int idRubroFlujoIngreso) {
		this.idRubroFlujoIngreso = idRubroFlujoIngreso;
	}
	public int getIdRubroFlujoEgreso() {
		return idRubroFlujoEgreso;
	}
	public void setIdRubroFlujoEgreso(int idRubroFlujoEgreso) {
		this.idRubroFlujoEgreso = idRubroFlujoEgreso;
	}
	...
	public int getPiFormaPago() {
		return piFormaPago;
	}
	public void setPiFormaPago(int piFormaPago) {
		this.piFormaPago = piFormaPago;
	}
	public int getPiTipoOperacion() {
		return piTipoOperacion;
	}
	public void setPiTipoOperacion(int piTipoOperacion) {
		this.piTipoOperacion = piTipoOperacion;
	}
	...
	public boolean isBRegreso() {
		return bRegreso;
	}
	public void setBRegreso(boolean regreso) {
		bRegreso = regreso;
	}
	...
	public String getOrigenReg() {
		return origenReg;
	}
	public void setOrigenReg(String origenReg) {
		this.origenReg = origenReg;
	}
	...
	public String getPvvValor1() {
		return pvvValor1;
	}
	public void setPvvValor1(String pvvValor1) {
		this.pvvValor1 = pvvValor1;
	}
	public String getPvvValor2() {
		return pvvValor2;
	}
	public void setPvvValor2(String pvvValor2) {
		this.pvvValor2 = pvvValor2;
	}
	...
	public Date getFecInversion() {
		return fecInversion;
	}
	public void setFecInversion(Date fecInversion) {
		this.fecInversion = fecInversion;
	}
	public String getBeneficiarion() {
		return beneficiarion;
	}
	public void setBeneficiarion(String beneficiarion) {
