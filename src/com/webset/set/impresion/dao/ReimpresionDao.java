...
public interface ReimpresionDao {
	...
	public int actualizarCaja(int caja, int noEmpresa);
	...
	int actualizarMovimiento(Date fechaHoy, int usuario, Date fechaChequeCapturada, Date fechaCheque, int noCheque, String motivoReimpresion, int noFolioMov);
