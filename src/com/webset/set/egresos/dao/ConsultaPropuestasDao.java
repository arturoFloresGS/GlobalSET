...
public interface ConsultaPropuestasDao {
	...
	public int actualizarBanCheqPropuesta(String sFolios, int formaPago, int idBanco, String idChequera, int idBancoBenef, String idChequeraBenef, boolean actualizaBeneficiario, String idDivisa, double tipoCambio, String bTraspaso, String campoRef, String referencia1, String referencia2, String referencia3);
	...
	int chequeraCIE(String cveControl);
	...
	int confPagoCruzado(String cveControl);
	public int verificaCompraTransfer(String cveControl);
	public int consultaAutorizada(String cveControl);
	public List<Map<String, String>> consultarDetalleStoredParaExcel(PagosPropuestosDto consDetalleDto);
	...
	public boolean existeAutorizacion(String cveControl, int idUsuario, boolean ban, boolean ban2, boolean b);
	public List<Map<String, Object>> obtenerReportePropuestasAutorizadas(PagosPropuestosDto consDetalleDto);
