...
public interface ConsultaPropuestasService {
	...
	public HSSFWorkbook obtenerDetallesReporte(int i);
	...
	public List<SeleccionAutomaticaGrupoDto> obtenerNiveles(GrupoEmpresasDto dtoIn);
	...
	public String aceptarModificar(List<Map<String, String>> mapGridProp, List<Map<String, String>> mapGridDetProp,
			int i, int j, String idChequera, int k, String idChequeraBenef, boolean actualizaBeneficiario,
			String fecHoy, String idDivisa, double tipoCambio, String folios, String campoRef, String referencia1,
			String referencia2, String referencia3);
	public JRDataSource obtenerReportePropuestasAutorizadas(SeleccionAutomaticaGrupoDto dtoIn);
	public Map<String, String> actualizaCVT(String string);
}