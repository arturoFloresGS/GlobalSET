...
public class MovimientoDto {
	...
	private int	noEmpresaDos;
	private int	noFolioDet;
	private int	nvoFolioMov;
	...
	private String bServicios;
	private double importeMn;
	private double importeDls;
	private double totalDls;
	private String nomProveedor;
	private String bancoPago;
	private String descGrupoCupo;
	private String descGrupoFlujo;
	private int numCheqPagoMN;
	private int numCheqPagoDLS;
	private int numCheqCruceMN;
	private int numCheqCruceDLS;
	private int numCheqEmp;
	private int numCheqCte;
	private String equivale;
	private int empChe;
	private String idGrupoFlujo;
	private String idGrupoCupo;
	private int numIntercos;
	private int totalIntercos;
	private String idDivisaCte;
	private int idBancoPago;
	private String idChequeraPago;
	private String idDivisaPago;
	private int idBancoCte;
	private String idChequeraCte;
	private String idCtaContable;
	private String descCtaContable;
	private int bcoPagoCruzado; 
	private String cheqPagoCruzado; 
	private String divPagoCruzado; 
	private double impPagoCruzado;
	private double tipoCambioCruzado;
	...
	private String noContratoMass;
	private String descPlaza; 
	private int usuarioBE;
	private int idContrato;
	private double noContrato;
	...
	//AGREGADAS EMS PARA FORMATO DE FECHA EN STRING. PARA PRESENTACIÓN DE LOS GRIDS.
	private String fecOperacionStr;
	private String fecValorStr;
	private String fecValorOriginalStr;
	private String fecPropuestaStr;
	private String fecContabilizacionStr;
...
//	para tipos de cambio
	private double	tipo_cambio1;
	private double	tipo_cambio2;
	private double	tipo_cambio3;
	...
	public int getUsuarioBE() {
		return usuarioBE;
	}
	public void setUsuarioBE(int usuarioBE) {
	...
	public double getNoContrato() {
		return noContrato;
	}
	public void setNoContrato(double noContrato) {
		this.noContrato = noContrato;
	}
	public String getNoContratoMass() {
		return noContratoMass;
	}
	public void setNoContratoMass(String noContratoMass) {
		this.noContratoMass = noContratoMass;
	}
	...
	public String getAgrupa1() {
		return agrupa1;
	}
	public void setAgrupa1(String agrupa1) {
		this.agrupa1 = agrupa1;
	}
	public String getAgrupa2() {
		return agrupa2;
	}
	public void setAgrupa2(String agrupa2) {
		this.agrupa2 = agrupa2;
	}
	public String getAgrupa3() {
		return agrupa3;
	}
	public void setAgrupa3(String agrupa3) {
	...
	public int getNumCheqPagoMN() {
		return numCheqPagoMN;
	}
	public void setNumCheqPagoMN(int numCheqPagoMN) {
		this.numCheqPagoMN = numCheqPagoMN;
	}
	public int getNumCheqPagoDLS() {
		return numCheqPagoDLS;
	}
	public void setNumCheqPagoDLS(int numCheqPagoDLS) {
		this.numCheqPagoDLS = numCheqPagoDLS;
	}
	public int getNumCheqCruceMN() {
		return numCheqCruceMN;
	}
	public void setNumCheqCruceMN(int numCheqCruceMN) {
		this.numCheqCruceMN = numCheqCruceMN;
	}
	public int getNumCheqCruceDLS() {
		return numCheqCruceDLS;
	}
	public void setNumCheqCruceDLS(int numCheqCruceDLS) {
		this.numCheqCruceDLS = numCheqCruceDLS;
	}
	public int getNumCheqEmp() {
		return numCheqEmp;
	}
	public void setNumCheqEmp(int numCheqEmp) {
		this.numCheqEmp = numCheqEmp;
	}
	public int getNumCheqCte() {
		return numCheqCte;
	}
	public void setNumCheqCte(int numCheqCte) {
		this.numCheqCte = numCheqCte;
	}
	...
	public int getEmpChe() {
		return empChe;
	}
	public void setEmpChe(int empChe) {
		this.empChe = empChe;
	}
	...
	public double getImporteDls() {
		return importeDls;
	}
	public void setImporteDls(double importeDls) {
		this.importeDls = importeDls;
	}
	public double getTotalDls() {
		return totalDls;
	}
	public void setTotalDls(double totalDls) {
		this.totalDls = totalDls;
	}
	public String getIdGrupoFlujo() {
		return idGrupoFlujo;
	}
	public void setIdGrupoFlujo(String idGrupoFlujo) {
		this.idGrupoFlujo = idGrupoFlujo;
	}
	public String getIdGrupoCupo() {
		return idGrupoCupo;
	}
	public void setIdGrupoCupo(String idGrupoCupo) {
	...
	public String getIdChequeraPago() {
		return idChequeraPago;
	}
	public void setIdChequeraPago(String idChequeraPago) {
		this.idChequeraPago = idChequeraPago;
	}
	...
	public int getIdBancoCte() {
		return idBancoCte;
	}
	public void setIdBancoCte(int idBancoCte) {
		this.idBancoCte = idBancoCte;
	}
	public String getIdChequeraCte() {
		return idChequeraCte;
	}
	public void setIdChequeraCte(String idChequeraCte) {
		this.idChequeraCte = idChequeraCte;
	}
	public int getBcoPagoCruzado() {
		return bcoPagoCruzado;
	}
	public void setBcoPagoCruzado(int bcoPagoCruzado) {
	...
	public double getImpPagoCruzado() {
		return impPagoCruzado;
	}
	public void setImpPagoCruzado(double impPagoCruzado) {
		this.impPagoCruzado = impPagoCruzado;
	}
	public double getTipoCambioCruzado() {
		return tipoCambioCruzado;
	}
	public void setTipoCambioCruzado(double tipoCambioCruzado) {
		this.tipoCambioCruzado = tipoCambioCruzado;
	}
	...
	public String getFecOperacionStr() {
		return fecOperacionStr;
	}
	public void setFecOperacionStr(String fecOperacionStr) {
		this.fecOperacionStr = fecOperacionStr;
	}
	public String getFecValorStr() {
		return fecValorStr;
	}
	public void setFecValorStr(String fecValorStr) {
		this.fecValorStr = fecValorStr;
	}
	public String getFecValorOriginalStr() {
		return fecValorOriginalStr;
	}
	public void setFecValorOriginalStr(String fecValorOriginalStr) {
		this.fecValorOriginalStr = fecValorOriginalStr;
	}
	...
	public String getFecContabilizacionStr() {
		return fecContabilizacionStr;
	}
	public void setFecContabilizacionStr(String fecContabilizacion) {
		this.fecContabilizacionStr = fecContabilizacion;
	}
	...
	public String getIdCtaContable() {
		return idCtaContable;
	}
	public void setIdCtaContable(String idCtaContable) {
	...
	public int getNoEmpresaDos() {
		return noEmpresaDos;
	}
	public void setNoEmpresaDos(int noEmpresaDos) {
		this.noEmpresaDos = noEmpresaDos;
	}
	public int getNvoFolioMov() {
		return nvoFolioMov;
	}
	public void setNvoFolioMov(int nvoFolioMov) {
		this.nvoFolioMov = nvoFolioMov;
	}
	public String getPlazaStr() {
		return plazaStr;
	}
	public void setPlazaStr(String plazaStr) {
		this.plazaStr = plazaStr;
	}
	...
	public double getTipo_cambio1() {
		return tipo_cambio1;
	}
	public void setTipo_cambio1(double tipo_cambio1) {
		this.tipo_cambio1 = tipo_cambio1;
	}
	public double getTipo_cambio2() {
		return tipo_cambio2;
	}
	public void setTipo_cambio2(double tipo_cambio2) {
		this.tipo_cambio2 = tipo_cambio2;
	}
	public double getTipo_cambio3() {
		return tipo_cambio3;
	}
	public void setTipo_cambio3(double tipo_cambio3) {
		this.tipo_cambio3 = tipo_cambio3;
	}
